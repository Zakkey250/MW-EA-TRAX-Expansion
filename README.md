...
Source code for **version 0.4.6**, an ASI mod for Need for Speed Most Wanted (2005), and its optional The Run Pursuit Converter.

**[Build instructions / ビルド手順](NFSMWEATraxExpansion/docs/BUILD-046.md)** · **[Installation guide / 導入ガイド](NFSMWEATraxExpansion/docs/User-Guide.md)** · **[Converter guide / コンバーター](NFSMWEATraxExpansion/docs/Converter-README.md)**
...
バージョン0.4.6のMOD本体と、任意導入のThe Runコンバーターのソースです。お手持ちのMP3・WAVやUnderground 2の曲をEA TRAXへ追加し、任意でThe Runの追跡BGMを取り込めます。
...
配布版の再ビルドに必要なヘッダー、vgmstream静的ライブラリ、mpg123のリンク依存ファイル、および対応するvgmstreamソースを含めています。導入用ZIPではありません。詳細は[ビルド手順](NFSMWEATraxExpansion/docs/BUILD-046.md)をご覧ください。

## Release source provenance

Imported from `NFSMWEATraxExpansion-Source-v0.4.6.zip`.

Archive SHA-256: `B76708B0F011B4AE4CFAF4F8E604DD7849E18BB41ACDC4B20B0D072F7089750A`.

The imported project and upstream files are unchanged. The root README, Git configuration files, and source checksum manifest are prepared for this repository. `SHA256SUMS.txt` lists repository source file hashes, excluding itself.
