"""Build audited 0.4.6 player and optional converter ZIPs without audio or nested archives."""
...
for destination,source in {
 'README.md':'docs/Package-README.md',prefix+'README.md':'docs/User-Guide.md',
...
runtime=ROOT/'staging/eatrax-046-runtime/BuildCache'
...
reports=[package('NFSMWEATraxExpansion-v0.4.6',files)]
reports.append(package('TheRunPursuitConverter-v0.4.6',{
...
(ROOT/'dist/packages-0.4.6.json').write_text(json.dumps(reports,indent=2))
case_pointer=ROOT/'diagnostics/eatrax-046-case.txt'
