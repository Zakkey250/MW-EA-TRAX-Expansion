...
for name in ('README.md','NFSMWEATraxExpansion.sln','NFSMWEATraxExpansion.vcxproj','NFSMWEATraxProbe.vcxproj','StartupTests.vcxproj',
             ...
             'tools/Build-047.ps1','tools/Package-047.py','tools/Package-Source-047.py','tools/Test-CompressedCache.py','docs/Compressed-Cache-Validation.md','docs/Release-Security-Checks.md','docs/Release-0.4.7.md','tools/Probe.cpp','tools/Test-HookSurface.ps1',
             'docs/Source-README.md','docs/BUILD-047.md','docs/Package-README.md','docs/User-Guide.md','docs/Converter-README.md',
...
items['README.md']=(project/'docs/Source-README.md').read_bytes()
...
out=root/'dist/NFSMWEATraxExpansion-Source-v0.4.7.zip'
